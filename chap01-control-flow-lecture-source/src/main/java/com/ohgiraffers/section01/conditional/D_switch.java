...
public class D_switch {
    ...
    *  case[비교값2] :비교값2과 일치하는경우 실행할 구문; break;
    *  default : case에 모두 해당하지 않는 경우 실행할 구문;break;
    * }
    *
    * 여러개의 비교값중 일치하는 조건에 해당하는 로직을 실행하는것
    * if-else-if와 유사하다
    * 일부호환도 가능하다
    * switch문으로 비교가능한 값은 정수, 문자,문자열 형태의 값이다.
    * 정확하게 일치하는 경우만 비교가 가능하다. 대소비교를 할수없다.
    * case절에느 변수를 사용할수없다(값만 비교 가능)
    * */

    /*
    * 정수 두개와 연산자 기호문자를 입력받아서
    * 두숫자의 연산결과를 출력해보는 간단한 계산기 만들기
    * */
...
//        연산결과를 저장할 변수
        ...
        public void testSwitchVendingMachine(){
            /*
            swich문을 이용해서 문자열값 비교 및 break에 대한 테스트
            *1.JDK 1.7이상부터 switch문을 이용해 문자열을 비교할수있다
