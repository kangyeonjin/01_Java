...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * 다차원배열
        * 다차원배열은 2차원이상의 배열을 의미한다
        * 배열의 인덱스마다 또 다른 배열의 주소를 보관하는 배열을 의미한다
        * 2차원배열은 1차원배열 여러개를 하나로 묶어서 관리하는 배열을 의미한다
        * */

        /*2차원배열을 사용하는 방법
        * 1. 배열의 주소를 보관하는 레퍼런스 변수 선언(stack)
        * 2. 여러개의 1차원배열의 주소를 관리하는 배열을 생성(heap)
        * 3. 각 인덱스에서 관리하는 배열을 할당하여 주소를보관하는 배열에 저장
        * 4. 생성한 여러개의 1차원배열에 차례로 접근해서 사용
        * */

        int[][] arr;
        int arr2 [][];

        //arr = new int[][];  //크기를 지정하지 않으면 에러발생
//        arr2 = new int[][2];
        ...
        //크기 할당후에 아무값을 대입하지 않아도
        //heap영역에는 값이 없는 상태로 공간 생성이 불가능하기 때문에 기본값이 들어있다.
