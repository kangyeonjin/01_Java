package com.ohgiraffers.section4.overflew;
...
* 언더플로우
*
* 오버플로우와 반대개념으로 최소범위보다 작은 수를 발생시키는 경우 발생하는 현상
*
*
* */

        byte num2 = -128; //바이트 최소저장범위
        ...
        /*
        *해결방법
        * 오버플로우를 예측하고 더 큰자료형으로 결과값을 받아서 처리함
        * */
        ...
        longMulti = (long)firstNum * secondNum;  //강제 형변한
